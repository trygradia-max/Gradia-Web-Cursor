      ...
      <form className="mt-6 space-y-5" onSubmit={onSubmit}>
        <div>
          ...
          <input
            ...
            autoComplete="name"
            required
            className="mt-2 w-full rounded-xl border border-[#e2e8f0] bg-[var(--brand-light)] px-4 py-3 text-[var(--brand-dark)] placeholder:text-[var(--brand-slate)]/60 focus:border-[var(--brand-amber)] focus:outline-none focus:ring-1 focus:ring-[var(--brand-amber)]"
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={5}
            className="mt-2 w-full resize-y rounded-xl border border-[#e2e8f0] bg-[var(--brand-light)] px-4 py-3 text-[var(--brand-dark)] placeholder:text-[var(--brand-slate)]/60 focus:border-[var(--brand-amber)] focus:outline-none focus:ring-1 focus:ring-[var(--brand-amber)]"
