        ...
        {AGENTS.map((a) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="wl-pulse-glow u-pill flex h-6 w-6 items-center justify-center bg-[var(--brand-primary)] text-white transition-transform duration-200 group-hover:scale-110">
