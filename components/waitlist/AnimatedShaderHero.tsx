    ...
    <section className="relative h-[100svh] min-h-[600px] w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-5 text-center">
        ...
        >
          ...
          Now in private beta · First 1,000 get 50% off year one
        </span>
        ...
        >
          Built for car detailers. Gradia is 7 AI agents that answer your phone,
          quote every car, fill your calendar, and chase your invoices — so you
